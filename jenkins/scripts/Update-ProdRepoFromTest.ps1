...
$testPkgs = choco list --source $TestRepo --limit-output | ConvertFrom-Csv -Delimiter '|' -Header Name, Version
$prodPkgs = choco list --source $ProdRepo --limit-output | ConvertFrom-Csv -Delimiter '|' -Header Name, Version
